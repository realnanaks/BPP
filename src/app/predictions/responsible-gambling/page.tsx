...
// --- Mock Data (simulating the ML pipeline output) ---
...
// --- CRG Logic (Client-Side implementation for Simulator) ---
    ...
    return (
        <div className="rg-container">
            <div className="page-header">
                <div>
                    <h1 className="page-title">Responsible Gambling AI</h1>
                    <p className="page-subtitle">Composite Responsible Gambling Risk (CRG) metrics and real-time player protection.</p>
                </div>
                <div className="header-actions">
                    <button className="btn-secondary"><Shield size={16} /> Config Policies</button>
                    <button className="btn-primary"><CheckCircle size={16} /> Audit Report</button>
                </div>
            </div>
            ...
            <style jsx>{`
        .rg-container { max-width: 1200px; margin: 0 auto; padding: 24px; color: #fff; }
        ...
        .btn-primary, .btn-secondary {
            display: flex; align-items: center; gap: 8px; padding: 8px 16px; border-radius: 8px; font-size: 13px; font-weight: 600; cursor: pointer; border: none;
        }
        ...
        .kpi-data .label { font-size: 12px; color: var(--color-text-secondary); text-transform: uppercase; }
        ...
        .control-group label { display: flex; justify-content: space-between; font-size: 14px; margin-bottom: 8px; }
        ...
        .math-header h2 { font-size: 24px; color: #fff; margin-bottom: 8px; }
        .math-header p { color: var(--color-text-secondary); max-width: 600px; margin: 0 auto; }

        .formula-display { background: rgba(0,0,0,0.3); padding: 32px; border-radius: 12px; margin-bottom: 40px; text-align: center; border: 1px solid rgba(255,255,255,0.05); }
        .formula-display h3 { margin: 0 0 16px 0; font-size: 14px; text-transform: uppercase; color: var(--color-text-secondary); }
        
        .math-block { font-family: 'JetBrains Mono', monospace; font-size: 20px; background: rgba(0,0,0,0.2); padding: 20px; border-radius: 8px; display: inline-block; margin-bottom: 24px; }
        ...
        .l-item { font-size: 13px; display: flex; align-items: center; gap: 8px; }
        .dot { width: 8px; height: 8px; border-radius: 50%; }
        ...
        .logic-card h4 { margin: 0 0 8px 0; color: #fff; font-size: 16px; }
        .logic-card p { margin: 0 0 16px 0; font-size: 13px; color: var(--color-text-secondary); }
        .logic-card ul { margin: 0; padding-left: 20px; font-size: 13px; }
        .logic-card li { margin-bottom: 6px; }

        .threshold-logic h3 { text-align: center; margin-bottom: 24px; font-size: 18px; }
        .decision-flow { display: flex; justify-content: center; align-items: center; gap: 16px; }
        .d-step { background: rgba(255,255,255,0.05); padding: 24px; border-radius: 12px; text-align: center; width: 200px; border: 1px solid transparent; transition: transform 0.2s; }
        ...
        .d-step .range { font-size: 12px; color: var(--color-text-secondary); margin-bottom: 4px; }
        .d-step .outcome { font-size: 18px; font-weight: 800; margin-bottom: 8px; }
        .d-step.safe .outcome { color: #4ade80; }
        .d-step.warn .outcome { color: #facc15; }
        .d-step.danger .outcome { color: #ef4444; }
        
        .d-step p { font-size: 12px; margin: 0; line-height: 1.4; opacity: 0.8; }
        .arrow { font-size: 24px; color: var(--color-text-secondary); opacity: 0.3; }
      `}</style>
        </div>
    );
}
